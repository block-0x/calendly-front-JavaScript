...
var timesAvailable = ["9:00", "10:00", "11:00", "2:00", "3:00"];

var free_busy_times = JSON.parse(sessionStorage.getItem("eventObj"))
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        select: function(info) {
            ...
            if (daySelected >= currentDay) {
                ...
                var h4node = document.createTextNode(getStringFromDate(daySelected));
